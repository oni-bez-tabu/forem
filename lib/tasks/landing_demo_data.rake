...
#
# UWAGA: plik musi miec rozszerzenie .rake, a nie .rb. Katalog lib jest w
# eager_load_paths, wiec skrypt z kodem na najwyzszym poziomie w lib/tasks/*.rb
# wykonuje sie przy kazdym starcie aplikacji w produkcji -- czyli nadpisywalby
# strone z danymi przy kazdym restarcie dyna.
#
# Uruchomienie:  rails landing:demo_data
namespace :landing do
  desc "Wypelnia strone landing-data realnymi postami, profilami i tagami"
